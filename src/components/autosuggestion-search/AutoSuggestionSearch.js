            ...
            return (
              <>
                <div className="relative mt-1 pb-2 d-flex justify-content-start">
                  ...
                  <Combobox.Options className="absolute px-0 radius:8 flex flex-column mt-5 max-h-60 w-100   overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                    {isLoading && (
                                        ...
                                        return (
                                          <>
                                            ...
                                            {isSelected(item) || selected ? (
                                              <span
                                                className={`absolute put-y-0  left-0 flex items-center pl-3 ${
                                                  active
                                                    ? "text-white"
                                                    : "text-teal-600"
                                                }`}
